...
import UIKit
//MapKit = uses Apple's mapping service & lets you easily display map, detect user's location, add overlays, & plot any location on map using pins and callouts
//  Can also perform reverse geocoding
import MapKit // prefixed with MK
import CoreData
